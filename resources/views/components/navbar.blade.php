<nav class="relative px-4 py-4 flex justify-between items-center bg-white dark:bg-gray-900">
  ...
  <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
    ...
    <a class="hidden lg:inline-block lg:mr-3 py-2 px-6 bg-gradient-to-r from-sky-500 to-cyan-300 hover:bg-sky-600 text-sm text-white font-bold rounded-xl transition duration-200" href="#">Sign up</a>
